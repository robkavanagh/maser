...
The installation steps for MASER are listed below. I also recommend you try out the dedicated [web app](https://maser.robkavanagh.xyz/)!
...
<p align="center">
<img src="assets/example lightcurve.png" width="80%"/>
</p>
...
While it is not a requirement for MASER, the underlying code was written to benefit from the enhanced performance offered by [Numba](https://numba.pydata.org/). With Numba, the function `maser` computes about **70 times faster**. See the script `examples/numba speedup.py` for a demonstration.
